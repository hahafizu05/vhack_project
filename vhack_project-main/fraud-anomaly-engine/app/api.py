...
def load_thresholds() -> Dict[str, float]:
    if (ARTIFACT_DIR / "metrics.joblib").exists():
        ...
        return {"flag_threshold": flag, "block_threshold": block}
    return {"flag_threshold": 0.25, "block_threshold": 0.6}
...
def score(tx: TransactionIn) -> ScoreOut:
    ...
    if proba >= thr["block_threshold"]:
        decision: Literal["Approve", "Flag", "Block"] = "Block"
    elif proba >= thr["flag_threshold"]:
        decision = "Flag"
    else:
        decision = "Approve"
